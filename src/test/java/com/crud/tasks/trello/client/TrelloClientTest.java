...
public class TrelloClientTest {
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/kamil29654480/boards?key=test&token=test&fields=name,id&lists=all");
    ...
    public void shouldReturnEmptyList() throws URISyntaxException {
        ...
        //Given
        URI uri = new URI("http://test.com/members/kamil29654480?key=test&token=test&fields=name,id&lists=all");
